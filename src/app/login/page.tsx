...
export default function LoginPage() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            <Card className="w-full max-w-md mx-4 relative z-10 bg-slate-900/80 border-slate-700 backdrop-blur-xl">
                <CardHeader className="text-center space-y-4">
                    ...
                    <CardDescription className="text-slate-400">
                        Protect your courses from piracy. Auto-detect and takedown unauthorized copies.
                    </CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700">
                        <div className="text-center">
                            ...
                            <p className="text-xs text-slate-400">24/7 Scanning</p>
                        </div>
                        <div className="text-center">
                            <div className="w-10 h-10 mx-auto mb-2 rounded-lg bg-pink-500/10 flex items-center justify-center">
                                <Shield className="w-5 h-5 text-pink-400" />
                            </div>
                            <p className="text-xs text-slate-400">Auto Takedowns</p>
                        </div>
                        <div className="text-center">
                            <div className="w-10 h-10 mx-auto mb-2 rounded-lg bg-blue-500/10 flex items-center justify-center">
                                <Lock className="w-5 h-5 text-blue-400" />
                            </div>
                            <p className="text-xs text-slate-400">Legal Notices</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
